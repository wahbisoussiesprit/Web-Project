        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Creatine Monohydrate - Payment Section</h2>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/featured/n3.jpg">

                        </div>
                        <div class="featured__item__text">
                            <h6><a href="creatine.php">Creatine Monohydrate</a></h6>
                            <h5>$20.00</h5>
                        </div>
                    </div>
                </div>
