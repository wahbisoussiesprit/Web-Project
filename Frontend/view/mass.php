        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Serious Mass - Payment Section</h2>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fastfood">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/featured/n2.jpg">

                        </div>
                        <div class="featured__item__text">
                            <h6><a href="mass.php" align="center">Serious Mass</a></h6>
                            <h5>$50.00</h5>
                        </div>
                    </div>
                </div>
